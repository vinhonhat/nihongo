// games/nihongo/data/n2/index.js
// N2 lesson loader V1.1.8
...
window.NIHONGO_DATA.n2 = window.NIHONGO_DATA.n2 || {};
window.NIHONGO_DATA.n2.lessons = window.NIHONGO_DATA.n2.lessons || {};
window.NIHONGO_DATA.n2.lessonsMeta = window.NIHONGO_DATA.n2.lessonsMeta || [];
...
(function () {
    function rebuildNihongoLevelFromLessons(levelName) {
        ...
        // Dữ liệu tổng hợp dùng cho chế độ "Toàn bộ N2".
    ...
    // Tự nạp 25 file bài của N2. Nhờ vậy index.html chỉ cần gọi index.js, không cần 25 thẻ script.
    for (let i = 1; i <= 25; i += 1) {
        const num = String(i).padStart(2, '0');
        document.write('<script src="games/nihongo/data/n2/lesson' + num + '.js"><\/script>');
    }
})();
