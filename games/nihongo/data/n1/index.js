// games/nihongo/data/n1/index.js
// N1 lesson loader V1.1.8
...
window.NIHONGO_DATA.n1 = window.NIHONGO_DATA.n1 || {};
window.NIHONGO_DATA.n1.lessons = window.NIHONGO_DATA.n1.lessons || {};
window.NIHONGO_DATA.n1.lessonsMeta = window.NIHONGO_DATA.n1.lessonsMeta || [];
...
(function () {
    function rebuildNihongoLevelFromLessons(levelName) {
        ...
        // Dữ liệu tổng hợp dùng cho chế độ "Toàn bộ N1".
    ...
    // Tự nạp 25 file bài của N1. Nhờ vậy index.html chỉ cần gọi index.js, không cần 25 thẻ script.
    for (let i = 1; i <= 25; i += 1) {
        const num = String(i).padStart(2, '0');
        document.write('<script src="games/nihongo/data/n1/lesson' + num + '.js"><\/script>');
    }
})();
